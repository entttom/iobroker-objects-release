...
#ifndef IOBROKER_OBJECTS_WATCH_WIDGETS_SWIFT_H
#define IOBROKER_OBJECTS_WATCH_WIDGETS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ioBroker_Objects_Watch_Widgets",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
